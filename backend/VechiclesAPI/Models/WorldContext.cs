...
namespace VechiclesAPI.Models
{
    public partial class WorldContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VechicleReturn>(entity =>
            {
                ...
                entity.HasOne(d => d.Rental)
                    .WithOne(p => p.VechicleReturn)
                    .HasForeignKey<VechicleReturn>(d => d.RentalId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            Console.WriteLine("Seeding started XDDDDDDDDDDDDDD");
            #region WorkerSeed
            modelBuilder.Entity<Worker>().HasData(
                new Worker { Id = 1, FirstName = "Subaru", Surname = "Impreza", Pesel = "00000000000", Hascarepermissions = false, Isadmin = false, Password = "AA" },
                new Worker { Id = 2, FirstName = "Subaru", Surname = "Impreza", Pesel = "00000000000", Hascarepermissions = false, Isadmin = false, Password = "AA" },
                new Worker { Id = 3, FirstName = "Subaru", Surname = "Impreza", Pesel = "00000000000", Hascarepermissions = false, Isadmin = false, Password = "AA" },
                new Worker { Id = 4, FirstName = "Subaru", Surname = "Impreza", Pesel = "00000000000", Hascarepermissions = false, Isadmin = false, Password = "AA" },
                new Worker { Id = 5, FirstName = "Subaru", Surname = "Impreza", Pesel = "00000000000", Hascarepermissions = false, Isadmin = false, Password = "AA" },
                new Worker { Id = 6, FirstName = "Subaru", Surname = "Impreza", Pesel = "00000000000", Hascarepermissions = false, Isadmin = false, Password = "AA" },
                new Worker { Id = 7, FirstName = "Subaru", Surname = "Impreza", Pesel = "00000000000", Hascarepermissions = false, Isadmin = false, Password = "AA" },
                new Worker { Id = 8, FirstName = "Subaru", Surname = "Impreza", Pesel = "00000000000", Hascarepermissions = false, Isadmin = false, Password = "AA" },
                new Worker { Id = 9, FirstName = "Subaru", Surname = "Impreza", Pesel = "00000000000", Hascarepermissions = false, Isadmin = false, Password = "AA" },
                new Worker { Id = 10, FirstName = "Subaru", Surname = "Impreza", Pesel = "00000000000", Hascarepermissions = false, Isadmin = false, Password = "AA" },
                new Worker { Id = 11, FirstName = "Subaru", Surname = "Impreza", Pesel = "00000000000", Hascarepermissions = false, Isadmin = false, Password = "AA" },
                new Worker { Id = 12, FirstName = "Subaru", Surname = "Impreza", Pesel = "00000000000", Hascarepermissions = false, Isadmin = false, Password = "AA" });
            #endregion
            ...
            modelBuilder.Entity<ServiceExecution>().HasData(
                new ServiceExecution { Id = 1, VechicleId = 1, StartDate = new DateOnly(1970, 1, 1), EndDate = new DateOnly(1970, 1, 1), Description = "", IsFinished = false, VechicleCareId = 1, OfferedServiceId = 1 },
                new ServiceExecution { Id = 2, VechicleId = 1, StartDate = new DateOnly(1970, 1, 1), EndDate = new DateOnly(1970, 1, 1), Description = "", IsFinished = false, VechicleCareId = 1, OfferedServiceId = 1 },
                new ServiceExecution { Id = 3, VechicleId = 1, StartDate = new DateOnly(1970, 1, 1), EndDate = new DateOnly(1970, 1, 1), Description = "", IsFinished = false, VechicleCareId = 1, OfferedServiceId = 1 },
                new ServiceExecution { Id = 4, VechicleId = 1, StartDate = new DateOnly(1970, 1, 1), EndDate = new DateOnly(1970, 1, 1), Description = "", IsFinished = false, VechicleCareId = 1, OfferedServiceId = 1 },
                new ServiceExecution { Id = 5, VechicleId = 1, StartDate = new DateOnly(1970, 1, 1), EndDate = new DateOnly(1970, 1, 1), Description = "", IsFinished = false, VechicleCareId = 1, OfferedServiceId = 1 },
                new ServiceExecution { Id = 6, VechicleId = 1, StartDate = new DateOnly(1970, 1, 1), EndDate = new DateOnly(1970, 1, 1), Description = "", IsFinished = false, VechicleCareId = 1, OfferedServiceId = 1 },
                new ServiceExecution { Id = 7, VechicleId = 1, StartDate = new DateOnly(1970, 1, 1), EndDate = new DateOnly(1970, 1, 1), Description = "", IsFinished = false, VechicleCareId = 1, OfferedServiceId = 1 },
                new ServiceExecution { Id = 8, VechicleId = 1, StartDate = new DateOnly(1970, 1, 1), EndDate = new DateOnly(1970, 1, 1), Description = "", IsFinished = false, VechicleCareId = 1, OfferedServiceId = 1 },
                new ServiceExecution { Id = 9, VechicleId = 1, StartDate = new DateOnly(1970, 1, 1), EndDate = new DateOnly(1970, 1, 1), Description = "", IsFinished = false, VechicleCareId = 1, OfferedServiceId = 1 },
                new ServiceExecution { Id = 10, VechicleId = 1, StartDate = new DateOnly(1970, 1, 1), EndDate = new DateOnly(1970, 1, 1), Description = "", IsFinished = false, VechicleCareId = 1, OfferedServiceId = 1 },
                new ServiceExecution { Id = 11, VechicleId = 1, StartDate = new DateOnly(1970, 1, 1), EndDate = new DateOnly(1970, 1, 1), Description = "", IsFinished = false, VechicleCareId = 1, OfferedServiceId = 1 },
                new ServiceExecution { Id = 12, VechicleId = 1, StartDate = new DateOnly(1970, 1, 1), EndDate = new DateOnly(1970, 1, 1), Description = "", IsFinished = false, VechicleCareId = 1, OfferedServiceId = 1 });
            #endregion
            ...
            modelBuilder.Entity<VechicleReturn>().HasData(
                new VechicleReturn { Id = 1, Date = new DateOnly(1970, 1, 1), Description = "", MeterIndication = 0, FuelConsumption = 1, RentalId = 1 },
                new VechicleReturn { Id = 2, Date = new DateOnly(1970, 1, 1), Description = "", MeterIndication = 0, FuelConsumption = 1, RentalId = 2 },
                new VechicleReturn { Id = 3, Date = new DateOnly(1970, 1, 1), Description = "", MeterIndication = 0, FuelConsumption = 1, RentalId = 3 },
                new VechicleReturn { Id = 4, Date = new DateOnly(1970, 1, 1), Description = "", MeterIndication = 0, FuelConsumption = 1, RentalId = 4 },
                new VechicleReturn { Id = 5, Date = new DateOnly(1970, 1, 1), Description = "", MeterIndication = 0, FuelConsumption = 1, RentalId = 5 },
                new VechicleReturn { Id = 6, Date = new DateOnly(1970, 1, 1), Description = "", MeterIndication = 0, FuelConsumption = 1, RentalId = 6 },
                new VechicleReturn { Id = 7, Date = new DateOnly(1970, 1, 1), Description = "", MeterIndication = 0, FuelConsumption = 1, RentalId = 7 },
                new VechicleReturn { Id = 8, Date = new DateOnly(1970, 1, 1), Description = "", MeterIndication = 0, FuelConsumption = 1, RentalId = 8 },
                new VechicleReturn { Id = 9, Date = new DateOnly(1970, 1, 1), Description = "", MeterIndication = 0, FuelConsumption = 1, RentalId = 9 },
                new VechicleReturn { Id = 10, Date = new DateOnly(1970, 1, 1), Description = "", MeterIndication = 0, FuelConsumption = 1, RentalId = 10 },
                new VechicleReturn { Id = 11, Date = new DateOnly(1970, 1, 1), Description = "", MeterIndication = 0, FuelConsumption = 1, RentalId = 11 },
                new VechicleReturn { Id = 12, Date = new DateOnly(1970, 1, 1), Description = "", MeterIndication = 0, FuelConsumption = 1, RentalId = 12 });
            #endregion
        }
    }
}
